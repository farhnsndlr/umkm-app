            ...
            <div className="p-6 md:p-10">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{food.details}</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {activeTab === "menu" && (
                <div className="space-y-10">
                  {food.menu && food.menu.images.length > 0 && (
                    <div>
                      <h3 className="text-2xl font-bold mb-4">Menu</h3>
                      <div className="space-y-4">
                        {food.menu.images.map((imgSrc, index) => (
                          <img
                            key={`menu-${index}`}
                            src={imgSrc}
                            alt={`Menu ${food.title} ${index + 1}`}
                  ...
                  {food.tampilan && food.tampilan.images.length > 0 && (
                    <div>
                      <h3 className="text-2xl font-bold mb-4">Tampilan</h3>
                      <div className="grid grid-cols-2 gap-4">
                        {food.tampilan.images.map((imgSrc, index) => (
                          <img
                            key={`tampilan-${index}`}
                            src={imgSrc}
                            alt={`Tampilan ${food.title} ${index + 1}`}
